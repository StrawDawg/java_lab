...
//        сreateFirstFile(students);
    ...
    public static void сreateFirstFile(List<Student> students) throws IOException {
        students.add(new Student("Иванов Иван"));
        students.add(new Student("Липкович Мираиам"));
        students.add(new Student("Майя Шевко"));
        students.add(new Student("Шурхай Юрий"));
        students.add(new Student("Семененко Алексей"));
        students.add(new Student("Отюцкая Анастасия"));
        students.add(new Student("Первый Лжедмитрий"));
